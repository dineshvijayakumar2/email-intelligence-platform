...
def initialize_business_hierarchy_routers():
    ...
    init_intelligence_config_router(sb)  # Intelligence Config (taxonomy, classifier, cache)
...
app.include_router(intelligence_config_router, prefix="/api/v1")  # Intelligence Config
